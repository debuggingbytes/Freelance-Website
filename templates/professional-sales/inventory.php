...
<div id="wrapper">
	<div class="container-fluid">
		...
		<div class="scrolling-wrap blue-bg">
   		...
   		<!----------------- DISPLAY BY INVENTORY BY CAT  ----------------->
		
		<?php
			#print $_GET['cat'];
			switch(strtolower($_GET['cat'])){
				case "rt":
					print "<center>
						<h4>All Prices Listed in USD</h4>
						<h5>Inventory is updated frequently, Equipment Shown is available</h5>
						</center>";
					echo '<div class="row justify-content-center dark-bg">
						<iframe src="https://cranenetwork.com/iframe?u=72559&cat=rough-terrain-cranes" width="75%" height="900px"></iframe>				
					</div>';
				break;
				case "at":
					print "<center><h4>All Prices Listed in USD</h4><h5>Inventory is updated frequently, Equipment Shown is available</h5></center>";
					echo '<div class="row justify-content-center dark-bg">
					
		<iframe src="https://cranenetwork.com/iframe?u=72559&cat=all-terrain-cranes" width="75%" height="900px" ></iframe>						
						</div>';
				break;
				case "boomtruck":
					print "<center><h4>All Prices Listed in USD</h4><h5>Inventory is updated frequently, Equipment Shown is available</h5></center>";
		...
		<iframe src="https://cranenetwork.com/iframe?u=72559&cat=boom-truck-cranes"width="75%" height="900px" ></iframe>						
						</div>';
				break;
				case "carrydeck":
					print "<center><h4>All Prices Listed in USD</h4><h5>Inventory is updated frequently, Equipment Shown is available</h5></center>";
		...
		<iframe src="https://cranenetwork.com/iframe?u=72559&cat=carry-deck-industrial-cranes" width="75%" height="900px" ></iframe>						
						</div>';
				break;
				case "truckmount":
					print "<center><h4>All Prices Listed in USD</h4><h5>Inventory is updated frequently, Equipment Shown is available</h5></center>";
					echo '<div class="row justify-content-center dark-bg auto-size">
					
		<iframe src="https://cranenetwork.com/iframe?u=72559&cat=truck-mounted-telescopic-boom-cranes" width="75%" height="900px" ></iframe>						
						</div>';
				break;
				case "crawler":
					print "<center><h4>All Prices Listed in USD</h4><h5>Inventory is updated frequently, Equipment Shown is available</h5></center>";
					echo '<div class="row justify-content-center dark-bg">					
						<iframe src="https://cranenetwork.com/iframe?u=72559&cat=crawler-lattice-boom-cranes" width="75%" height="900px" ></iframe>						
						</div>';
				break;
				case "tower":
					print "<center><h4>All Prices Listed in USD</h4><h5>Inventory is updated frequently, Equipment Shown is available</h5></center>";
					echo '<div class="row justify-content-center dark-bg">				
						<iframe src="https://cranenetwork.com/iframe?u=72559&cat=tower-cranes" width="75%" height="900px" ></iframe>						
						</div>';
				break;
				case "all":
					print "<center><h4>All Prices Listed in USD</h4><h5>Inventory is updated frequently, Equipment Shown is available</h5></center>";
					echo '<div class="row justify-content-center dark-bg">				
						<iframe src="https://cranenetwork.com/iframe?u=72559" width="75%" height="3600px" ></iframe>						
						</div>';
				break;
				// Parts Section
				case "parts":
					print "<center><h4>All Prices Listed in USD</h4><h5>Inventory is updated frequently, Equipment Shown is available</h5></center>";
					echo '<div class="row justify-content-center dark-bg">				
						<iframe src="https://cranenetwork.com/iframe?u=72559&type=parts" width="75%" height="900px" ></iframe>						
						</div>';
				break;
				// Other Equipment - Tractors and Trailers
				case "equipment":
					print "<center><h4>All Prices Listed in USD</h4><h5>Inventory is updated frequently, Equipment Shown is available</h5></center>";
					echo '<div class="row justify-content-center dark-bg">				
						<iframe src="https://cranenetwork.com/iframe?u=72559&type=equipment" width="75%" height="900px" ></iframe>						
						</div>';
				break;
				//Fix "No Cat" Error
				case "":
		...
		<!----------------- ABOUT TEXT ROW 
		<div class="row justify-content-center about-row-small line-bg">
			<div class="col-sm-6">
				<h1>We're Reaching Higher Standards<i class="fas fa-caret-down"></i></h1>
				<p>
...
selling cranes all over the globe.
		...
		<!----------------- FOOTER 				<div class="row tile-bg footer">
			<div class="col-md-5">
